...
namespace RelaxingKoala.Data.Migrations
{
    ...
    [Migration("20241111111742_AddKitchen")]
    partial class AddKitchen
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RelaxingKoala.Models.Kitchen", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsPrepared = false,
                            MenuItemId = 1,
                            OrderTime = new DateTime(2024, 11, 11, 17, 17, 42, 294, DateTimeKind.Local).AddTicks(4980)
                        },
                        new
                        {
                            KitchenId = 2,
                            IsPrepared = false,
                            MenuItemId = 2,
                            OrderTime = new DateTime(2024, 11, 11, 16, 17, 42, 294, DateTimeKind.Local).AddTicks(4996)
                        },
                        new
                        {
                            KitchenId = 3,
                            IsPrepared = true,
                            MenuItemId = 3,
                            OrderTime = new DateTime(2024, 11, 11, 15, 17, 42, 294, DateTimeKind.Local).AddTicks(4997)
                        },
                        new
                        {
                            KitchenId = 4,
                            IsPrepared = true,
                            MenuItemId = 4,
                            OrderTime = new DateTime(2024, 11, 11, 16, 47, 42, 294, DateTimeKind.Local).AddTicks(4998)
                        },
                        new
                        {
                            KitchenId = 5,
                            IsPrepared = false,
                            MenuItemId = 5,
                            OrderTime = new DateTime(2024, 11, 11, 17, 32, 42, 294, DateTimeKind.Local).AddTicks(4999)
                        },
                        new
                        {
                            KitchenId = 6,
                            IsPrepared = true,
                            MenuItemId = 6,
                            OrderTime = new DateTime(2024, 11, 11, 15, 47, 42, 294, DateTimeKind.Local).AddTicks(5000)
                        });
                });
